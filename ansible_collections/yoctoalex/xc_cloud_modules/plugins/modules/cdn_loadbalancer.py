...
class ModuleManager(object):
    ...
    def remove(self):
        uri = f"/api/config/namespaces/{self.want.metadata['namespace']}/cdn_loadbalancers/{self.want.metadata['name']}"
    ...
    def create(self):
        uri = f"/api/config/namespaces/{self.want.metadata['namespace']}/cdn_loadbalancers"
